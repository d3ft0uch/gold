...
double MACDSignal, MACDSignalprev, MACDCurrent, MACDCurrentprev, MACDHist, Lag40, Lag40prev, Lag60, Lag60prev, Lag60prev2, Lag75, Lag75prev, Lag75prev2, gannPrev, gannPrev2, Stoch, Piv, TP=0, EMA60, EMA200, gann;
...
void checkconditions()
 ...
 //   Lag
      ...
      if ((lag60ShouldGoDown && (Lag60 < 0.85))  || GannSell) {
      ...
      //    Positive case                        negative case
      if ((lag60ShouldGoUp && (Lag60 > 0.15)) ||  GannBuy) {
