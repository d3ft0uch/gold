...
object StatsFunctions {
   ...
   */
  def iema(idx: Int, values: ArrayList[Double], period: Int, prev: Double): Double = iema(idx, values.toArray, period, prev)
  def iema(idx: Int, values: Array[Double], period: Int, prev: Double): Double = {
